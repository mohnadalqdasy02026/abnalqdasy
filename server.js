...
const codeMapping = {
    ...
    specialization: { "طب وجراحة": 1, "مختبرات طبية": 2, "تمريض عالي": 3, "علم التخدير": 4, "التغذية العلاجية": 5, "التصوير الشخصي": 6, "العلاج الطبيعي": 7, "علم السمع والنطق": 8, "علوم صيدلانية": 9 },
